...
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-8142fba7' );
});
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-6e156d09' );
});
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-ea175b8c' );
});
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-cc7e7782' );
});
window.addEventListener( 'load', function() {
